...
def centre_line(ax, c, x0, x1, alpha=1.0):
    """The principal axis of a shifted sine/cosine, dotted, under the curve.
    Adrian, 14 Sep 2026: a sketch of y = a sin/cos bx + c SHOWS its centre line y = c."""
    ax.plot([x0, x1], [c, c], 'k', ls=':', lw=0.9, alpha=alpha, zorder=1)
...
centre_line(ax,-1,0,np.pi,alpha=0.6); centre_line(ax,2,0,np.pi)
