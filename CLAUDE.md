...
| **Essay marking — English + 中文** (spec 12 Sep 2026, nothing built): feedback first, a band RANGE, never a point mark; the fixed error taxonomy per essay per student; calibration by consistency + ranking against each teacher + anchors, not ±2 of Adrian; a third Languages family in the app | [`SPEC-ESSAY-MARKING.md`](SPEC-ESSAY-MARKING.md) |
