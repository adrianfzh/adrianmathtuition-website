...
| **Grounding the chat solver on the bank** — the Telegram/web solver reads a photographed past-paper question without checking the bank that already holds its answer (spec 9 Sep 2026, NOT built; bot repo) | [`SPEC-SOLVER-BANK-GROUNDING.md`](SPEC-SOLVER-BANK-GROUNDING.md) |
