...
4. **Own daily allowance — TWO a day since 22 Sep 2026 (`DAILY_SCIENCE_SUBMIT_CAP` = 2; the maths cap is gone).** Was: one science paper per student per SGT day, counted separately from
