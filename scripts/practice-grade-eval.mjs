...
//     runtime model claude-opus-5-5, exactly as gradeAttempt() sends it;
...
// Env:  PRACTICE_EVAL_MODEL (default claude-opus-5-5), EVAL_SAMPLES (default 3)
...
const MODEL = process.env.PRACTICE_EVAL_MODEL || 'claude-opus-5-5'; // = GRADING_MODEL in practice-grade.ts — keep in sync
