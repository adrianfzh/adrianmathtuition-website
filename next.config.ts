...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ['@napi-rs/canvas', 'pdfjs-dist', 'sharp', '@sparticuz/chromium', 'katex', '@fontsource/tinos'],
  async rewrites() {
    return [
  ...
  outputFileTracingIncludes: {
    ...
    '/api/**/*': ['./node_modules/@sparticuz/chromium/bin/**', './node_modules/katex/dist/**', './node_modules/@fontsource/tinos/files/tinos-latin-*'],
    '/api/mark-batch/init': [
