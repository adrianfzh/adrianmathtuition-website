...
const QUESTION_COLUMNS =
  'id, question_text, parts, level, topics, total_marks, deleted_at, flagged_count, ai_generated, verified, has_image, image_url, answer, solution, school, national, legacy_syllabus';
