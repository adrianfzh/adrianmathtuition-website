  ...
  useEffect(() => {
    ...
    function buildDefaultEmailText(inv: any): string {
      ...
      if (inv.month === 'June 2026') {
        ...
        const howItWorks = `\n\nHow it works:\n\u2022 Revision lessons replace regular lessons in June. The two are mutually exclusive \u2014 if you sign up for the June revision sprint, there will be no regular June lessons. You can disregard the attached June invoice; a new separate invoice will be sent for the revision sign-up.\n\u2022 Regular lessons will resume in July.\n\u2022 If you opt out of the revision lessons, then it will be regular lessons in June as usual, and the attached invoice stands.\n\nTo sign up: ${wa}`;
        if (lvl === 'SEC4' || lvl === 'S4') {
          return header + `\n\n🏃 June Holiday Revision Sprint — Sec 4 (EM & AM)\n\nTo prepare students for their upcoming O Levels, I'm running a focused 4-week revision sprint over the June holidays, covering the major topics in the Sec 4 syllabus. Each session is split into concept teaching in the first half, followed by guided practice in the second.\n\nEM: Every Tue & Fri, 10am–12pm (2–26 Jun) — 8 lessons, $500\nAM: Every Tue & Fri, 1pm–3pm (2–26 Jun) — 8 lessons, $500\n\nFull revision schedule: adrianmathtuition.com/june-revision/sec4\n\nI'd strongly recommend students attend if they can as the revision sprint gives comprehensive revision coverage on the major topics tested.` + howItWorks + signOff;
        }
        if (lvl === 'JC2' || lvl === 'J2') {
          return header + `\n\n🏃 June Holiday Revision Sprint — JC2 H2 Mathematics\n\nTo prepare students for their upcoming A Levels, I'm running a focused 4-week revision sprint over the June holidays, covering the major topics in the H2 Math syllabus. Each session combines concept consolidation in the first half with exam-style guided practice in the second.\n\nEvery Mon & Thu, 12pm–2.30pm (1–25 Jun) — 8 lessons, $600\n\nFull revision schedule: adrianmathtuition.com/june-revision/jc2\n\nI'd strongly recommend students attend if they can as the revision sprint gives comprehensive revision coverage on the major topics tested.` + howItWorks + signOff;
        }
