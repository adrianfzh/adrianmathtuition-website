...
const EM_WEEKS: Week[] = [
  { label: 'Week 1 · 2–6 Jun',   tue: 'Algebra',                              fri: 'Coordinate Geometry / Graphs' },
  { label: 'Week 2 · 9–13 Jun',  tue: 'Trigonometry / Congruency & Similarity', fri: 'Circles / Mensuration' },
  { label: 'Week 3 · 16–20 Jun', tue: 'Math In Real World Context',            fri: 'Geometry' },
  { label: 'Week 4 · 23–27 Jun', tue: 'Arithmetic',                            fri: 'Practice Paper' },
];

const AM_WEEKS: Week[] = [
  { label: 'Week 1 · 2–6 Jun',   tue: 'Quadratic Functions / Surds',                     fri: 'Indices & Logarithms' },
  { label: 'Week 2 · 9–13 Jun',  tue: 'Coordinate Geometry & Circles',                    fri: 'Linear Law / Binomial Theorem' },
  { label: 'Week 3 · 16–20 Jun', tue: 'Polynomials & Partial Fractions / Plane Geometry', fri: 'Trigonometry' },
  { label: 'Week 4 · 23–27 Jun', tue: 'Differentiation',                                  fri: 'Integration' },
];

function CalendarTable({ weeks, color, bg, tueDate, friDate }: {
  weeks: Week[]; color: string; bg: string;
  tueDate: string; friDate: string;
}) {
  return (
...
export default function JuneRevisionPage() {
  return (
    <main style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', minHeight: '100vh', background: '#f8fafc', color: '#0f172a' }}>
      ...
      <div style={{ background: HEADER_BG, color: '#fff', padding: '28px 24px 24px', textAlign: 'center' }}>
        ...
        <a href="/june-revision/jc" style={{ display: 'inline-block', marginTop: 14, background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 8, padding: '7px 18px', fontSize: 13, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.25)' }}>
          View JC2 Schedule →
        </a>
      </div>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 20px 60px' }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.08)', border: `1px solid ${EM_BG}` }}>
            <CalendarTable weeks={EM_WEEKS} color={EM_COLOR} bg={EM_BG} tueDate="Tue" friDate="Fri" />
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.08)', border: `1px solid ${AM_BG}` }}>
            <CalendarTable weeks={AM_WEEKS} color={AM_COLOR} bg={AM_BG} tueDate="Tue" friDate="Fri" />
          </div>
        </div>

        {/* Notes */}
        <div style={{ marginTop: 36, background: '#fff', borderRadius: 12, padding: '18px 20px', border: '1px solid #e2e8f0', fontSize: 14, color: '#475569', lineHeight: 1.7 }}>
