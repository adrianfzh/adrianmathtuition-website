...
const EM_WEEKS: Week[] = [
  { label: 'Week 1 – Jun 2 & 5',   tue: 'Algebra + Indices',                     fri: 'Coordinate Geometry + Graphs' },
  { label: 'Week 2 – Jun 9 & 12',  tue: 'Trigonometry + Congruency & Similarity', fri: 'Circle Properties + Circular Measure' },
  { label: 'Week 3 – Jun 16 & 19', tue: 'Mensuration + Real World Qns',               fri: 'Number Patterns + Proportion + Polygons' },
];

const AM_WEEKS: Week[] = [
  { label: 'Week 1 – Jun 2 & 5',   tue: 'Quadratic Functions + Surds',                     fri: 'Indices & Logarithms' },
  { label: 'Week 2 – Jun 9 & 12',  tue: 'Coordinate Geometry & Circles',                    fri: 'Linear Law + Binomial Theorem' },
  { label: 'Week 3 – Jun 16 & 19', tue: 'Polynomials & Partial Fractions + Plane Geometry', fri: 'Trigonometry' },
  { label: 'Week 4 – Jun 23 & 26', tue: 'Differentiation and Applications',                  fri: 'Integration and Applications' },
];
