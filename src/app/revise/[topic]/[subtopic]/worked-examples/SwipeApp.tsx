...
export default function SwipeApp({ cards, subgroups, level, topic }: Props) {
  ...
  // First card of each sub-group gets a section chip
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex-none px-4 pt-safe-top pb-2 pt-4 border-b border-gray-100 flex items-center gap-2">
        <a
          href={`/revise/${level}`}
      ...
      {/* Progress dots + nav */}
      <div className="flex-none pb-safe-bottom pb-4 flex items-center justify-center gap-3 px-4">
        {/* Prev chevron */}
        <button
          onClick={goPrev}
          disabled={index === 0}
