        ...
        <section className="py-20 px-6 bg-card">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-16 items-center">
              <div className="relative w-full aspect-[3/4] bg-gradient-to-br from-navy to-navy-light rounded-2xl shadow-lg flex items-center justify-center overflow-hidden">
